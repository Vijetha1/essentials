...
def getMAP(queryLabels, databaseLabels, queryHashes, databaseHashes, curType, typeOfData='singleLabelled'):
	if typeOfData == 'singleLabelled':
	...
	MAP = calcMAP(groundTruthSimilarityMatrix, hammingRank, hammingDist)
	precisions = []
	recalls = []
	for i in range(3):
